...
3b. QUANTIFY IT, THEN ASK THEIR PLAN — once you have the emotional why, get them to put a NUMBER on it and then expose that they have no real plan. ONE question at a time: FIRST get the number — "What would it actually take, money-wise, to make that real for you — like how much more a month would genuinely change things?" If they're vague, help them land on a specific figure. THEN, on a later turn, ask about their plan — "And what's your plan right now to get there — are you actually on track for that?" Most people realize they don't have one. That gap — a real number they want, and no plan to reach it — is what creates the must. Remember the number they give; you'll use it in the close.
